...
<div class="w3-padding-64 " id="photos">
    <h2 class="w3-text-grey w3-center">Adding Events</h2>
    <hr style="width:200px" class="w3-opacity">
      ...
      $sql="INSERT INTO event ( eventdate, eventname, eventlocation, image, description) VALUES (  '$eventdate', '$eventname', '$eventlocation', '$image', '$description')";
    ...
    echo $eventname.' Added!';
        ...
        <form action="addevent.php" method="post" enctype="multipart/form-data">
            <table>
                ...
                <tr><td>Event Date:</td><td><input type="date" name="eventdate"></td></tr>
          
                <tr><td>Event Name:</td><td><input name="eventname"></td></tr>
                <tr><td>Event Location:</td><td><input name="eventlocation"accept=" "type="city"                     
                                                       class="form-control"  id="inputCity" placeholder="City" style="width:250px"></td></tr>
<tr><td>Image:</td><td><input type="file" name="image"></td></tr>

<tr><td>Details:</td><td><textarea rows="2" type="text" name="description"></textarea></td></tr>
            
                <tr><td><input name="submit" type="submit" value="submit">
