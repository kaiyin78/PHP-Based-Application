...
<div class="w3-padding-64 " id="photos">
    <h2 class="w3-text-grey w3-center">Delete Booking</h2>
    <hr style="width:200px" class="w3-opacity">
<?php 
$number=isset($_REQUEST['number'])?$_REQUEST['number']:'';
include 'klsconn.php';
$sql1="select * from booking where number='{$number}'";
...
if (isset($_POST['submit'])){
    ...
    $sql2="delete from booking where number='{$number}'";
...
?>      
 ...
 <form action="deletebooking.php" method="post">
            <table>
                <a href="viewbooking.php"> View Booking</a><br>
                <input type="hidden" name="number" value="<?php echo $number?>">
                 ...
                 <tr><td>Email</td><td><?php echo $email?><input type="hidden" name="email" value="<?php echo $email?>"></td></tr>
                <tr><td>Quantity</td><td><?php echo $quantity?><input type="hidden" name="quantity" value="<?php echo $quantity?>"></td></tr>
                <tr><td>Contact No</td><td><?php echo $contactno?><input type="hidden" name="contactno" value="<?php echo $contactno?>"></td></tr>
                      
       
                <tr><td colspan="2"><input name="submit" type="submit" value="Yes">
                        <input name="reset" type="reset" value="Cancel" onclick="location='viewbooking.php'"></td></tr>
