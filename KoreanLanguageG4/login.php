...
<div class="w3-dropdown-hover w3-hide-small">
    <a href="userevent.php" class="w3-padding-48 w3-bar-item w3-button" title="Notifications">EVENTS <i class="fa fa-caret-down"></i>  </a>   
    <div class="w3-dropdown-content w3-card-4 w3-bar-block">
        
    </div>
  </div>
        <a href="contactus.php" class="w3-padding-48 w3-bar-item w3-button"><i class="fa fa-envelope"></i>CONTACT US</a>
        <a href="login.php" class="w3-padding-48 w3-bar-item w3-button"></i>LOGIN</a>
    </div>
...
<nav class="w3-sidebar w3-bar-block w3-black w3-card w3-animate-left w3-hide-medium w3-hide-large" style="display:none" id="mySidebar">
  ...
  <a href="adminaboutus.php" onclick="w3_close()" class="w3-bar-item w3-button">ABOUT US</a>
  <a href="events.php" onclick="w3_close()" class="w3-bar-item w3-button">EVENTS</a>
  <a href="admincontactus.php" onclick="w3_close()" class="w3-bar-item w3-button">CONTACT US</a>
  <a href="adminprofile.php" onclick="w3_close()" class="w3-bar-item w3-button">LOGIN</a>
</nav>
<head>
	<title>Korean Language</title>
