...
<div class="w3-padding-64 " id="photos">
    <h2 class="w3-text-grey w3-center">Delete Event</h2>
 ...
 <form action="deleteevent.php" method="post">
            <table>
                <a href="events.php"> Events</a><br>
                 ...
                 <tr><td>Event date:</td><td><?php echo $eventdate?><input type="hidden" name="eventdate" value="<?php echo $eventdate?>"></td></tr>
                 <tr><td>Event Name:</td><td><?php echo $eventname?><input type="hidden" name="eventname" value="<?php echo $eventname?>"></td></tr>
                <tr><td>Event location:</td><td><?php echo $eventlocation?><input type="hidden" name="eventlocation" value="<?php echo $eventlocation?>"></td></tr>
                <tr><td>Image:</td><td><?php echo $image?><input type="hidden" name="image" value="<?php echo $image?>"></td></tr>
                <tr><td>Description:</td><td><?php echo $description?><input type="hidden"name="description" value="<?php echo $description?>"></td></tr>       
       
                <tr><td colspan="2"><input name="submit" type="submit" value="Yes">
