...
$sql1="select * from event where eventname='{$eventname}'";
...
extract($row);
        ...
        ?>
     <table style="width:100%;padding: 8px; text-align: left; color: #003366 ">
    <tr><th>Event ID</th><th>Event Name</th><th>Event Date</th><th>Image</th><th>Event Location</th><th>Description</th></tr>
    <?php
...
<a href='booking.php?eventid={$row['eventid']}' class='w3-button w3-light-grey w3-padding-large w3-hover-black' >Booking</a>";
