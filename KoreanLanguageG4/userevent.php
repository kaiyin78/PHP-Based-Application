...
<p>space</p>
    ...
    <a href='eventdetail.php?eventname={$row['eventname']}'> <img src='img/".$row['image']."'alt='logo' class='events_img w3-hover-opacity' style='width:320px 'height:315px'; >
    <h3 class='w3-center'><a href='eventdetail.php?eventname={$row['eventname']}' style=' text-decoration: none'>{$row['eventname']}</a></h3>
